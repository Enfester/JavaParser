...
public final class SerializationException extends RuntimeException {
    ...
    /**
     * Creates and initializes a new serialization exception with no error
     * message and cause.
     */
    ...
    /**
     * Creates and initializes a new serialization exception with the given
     * error message and no cause.
     *
     * @param message the error message of the new serialization exception (may
     * be <code>null</code>).
     */
     ...
     *
     * @param cause the cause of the new serialization exception (may be
     * <code>null</code>).
     */
