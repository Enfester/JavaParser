...
public class Tag {
     ...
     * @deprecated No longer used, and no different result than
     * {{@link #isBlock()}}
     */
    ...
    /**
     * Get if this tag represents a control associated with a form. E.g. input,
     * textarea, output
     *
    ...
    /**
     * Get if this tag represents an element that should be submitted with a
     * form. E.g. input, option
     *
