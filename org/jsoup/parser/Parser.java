...
public class Parser {
     ...
     *
     * @param maxErrors the maximum number of errors to track. Set to 0 to
     * disable.
     * @return this, for chaining
     */
     ...
     * @param baseUri base URI of document (i.e. original fetch location), for
     ...
     * @param context (optional) the element that this HTML fragment is being
     * parsed for (i.e. for inner HTML). This provides stack context (for
     ...
     * @param inAttribute if the string is to be escaped in strict mode (as
     * attributes are)
     ...
     * @param baseUri baseUri base URI of document (i.e. original fetch
     * location), for resolving relative URLs.
     *
     * @return parsed Document
