...
public class TokenQueue {
     ...
     *
     * @param seq any number of terminators to consume to. <b>Case
     * insensitive.</b>
     ...
     *
     * @param seq String to match up to, and not include in return, and to pull
    ...
    /**
     * Pulls a balanced string off the queue. E.g. if queue is "(one (two)
     * three) four", (,) will return "one (two) three", and leave " four" on the
     * queue. Unbalanced openers and closers can be quoted (with ' or ") or
     * escaped (with \). Those escapes will be left in the returned string,
     * which is suitable for regexes (where we need to preserve the escape), but
