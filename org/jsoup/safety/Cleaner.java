...
public class Cleaner {
     ...
     * whitelist. It is considered valid if all the tags and attributes in the
     * input HTML are allowed by the whitelist, and that there is no content in
     * the <code>head</code>.
     * <p>
     * This method can be used as a validator for user input. An invalid
