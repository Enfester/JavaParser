...
public class HttpConnection implements Connection {
     ...
     * getting different responses on their desktop vs in jsoup, which would
     * otherwise default to {@code Java}. So by default, use a desktop UA.
     */
    ...
    public static class Response extends HttpConnection.Base<Connection.Response> implements Connection.Response {
        ...
        /**
         * Instantiate Hostname Verifier that does nothing. This is used for
         * connections with disabled SSL certificates validation.
         *
         *
        ...
        /**
         * Initialise Trust manager that does not validate certificate chains
         * and add it to current SSLContext.
         * <p/>
